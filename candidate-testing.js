...
function gradeQuiz(candidateAnswers) {
  ...
  let grade = totalCorrectAnswers/totalQuestions * 100;
  console.log(`You got ${grade}% on the test.`);
  if (grade >= 80){
    console.log("Congratulations! You have passed!");
  } else {
    console.log("I'm sorry. You have failed the test.");
  }
...
function runProgram() {
  ...
  // TODO 1.1c: Greet candidate using their name //
   console.log("Hi " + candidateName + "! Welcome to the test! Good luck!");
  askQuestion();
